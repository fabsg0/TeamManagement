...
public class DepartmentService(HttpClient httpClient) : IDepartmentService
{
    ...
    {
        var departments =
            await httpClient.GetFromJsonAsync<List<TbDepartment>>("/Department/GetDepartments",
                cancellationToken);
        return departments ?? [];
    }
    ...
    {
        var department =
            await httpClient.GetFromJsonAsync<TbDepartment>($"/Department/GetDepartmentById/{id}",
                cancellationToken);
    ...
    {
        await httpClient.PostAsync("/Department/CreateDepartment", JsonContent.Create(department),
            cancellationToken);
    }
    ...
    {
        await httpClient.PutAsync($"/Department/UpdateDepartment/{id}",
    ...
    {
        await httpClient.DeleteAsync($"/Department/DeleteDepartment/{id}", cancellationToken);
    }
}